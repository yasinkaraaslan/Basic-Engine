...
VkRenderingAttachmentInfo Init::AttachmentInfo(VkImageView view, VkClearValue* clear, VkImageLayout layout)
{
...
VkRenderingAttachmentInfo Init::DepthAttachmentInfo(VkImageView view, VkImageLayout layout)
{
...
VkRenderingInfo Init::RenderingInfo(VkExtent2D renderExtent, VkRenderingAttachmentInfo* colorAttachment, VkRenderingAttachmentInfo* depthAttachment)
{
...
VkPipelineShaderStageCreateInfo Init::PipelineShaderStageCreateInfo(VkShaderStageFlagBits stage, VkShaderModule shaderModule, const char* entry)
{
